...
public class CampusMapActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    //IT-Zentrum
    items.add(
        new OverlayItem("IT-Zentrum Lingen", " Description", new GeoPoint(52.519207, 7.322921)));
